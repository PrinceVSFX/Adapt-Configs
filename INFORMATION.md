...
| Технология | Шифрование | Маскировка | Транспорт | Основное назначение |
|------------|------------|------------|------------|---------------------|
| VLESS + REALITY | TLS | Имитация реального HTTPS | TCP | Обход DPI и блокировок |
| SOCKS5 | Нет | Нет | TCP / UDP | Проксирование трафика |
| Hysteria2 | TLS | HTTP/3 / QUIC | UDP | Скорость и устойчивость |
| Trojan | TLS | Обычный HTTPS | TCP | Маскировка под HTTPS |
